            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        @if ($canArching)
                            <a class="nav-link {{ request()->is('archingcash') ? 'active' : '' }}"
                        ...
                        @if ($canDistribucion)
                            <a class="nav-link {{ request()->is('deliveries*') || request()->is('jug-movements*') || request()->is('loyalty*') ? '' : 'collapsed' }}"
                                href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseWater"
                            ...
                            <div class="collapse {{ request()->is('deliveries*') || request()->is('jug-movements*') || request()->is('loyalty*') ? 'show' : '' }}"
                                id="collapseWater" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav">
                                    @can('admin.deliveries')
                                        ...
                                        <a class="nav-link {{ request()->is('deliveries/qr') ? 'active' : '' }}"
                                            href="{{ route('admin.deliveries.qr') }}">
                                            Generador QR Pedidos
                                        </a>
                                    @endcan
                                    @can('admin.jug_movements')
                                        <a class="nav-link {{ request()->is('jug-movements*') ? 'active' : '' }}"
                                            href="{{ route('admin.jug_movements') }}">
                                            Control de Envases
                                        </a>
                                    @endcan
                                    @can('admin.loyalty')
                                        <a class="nav-link {{ request()->is('loyalty*') ? 'active' : '' }}"
                                            href="{{ route('admin.loyalty') }}">
                                            Fidelización (5+1)
                                        </a>
                                    @endcan
                                </nav>
